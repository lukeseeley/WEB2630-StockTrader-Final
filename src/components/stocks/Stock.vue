        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    {{stock.name}}
                    <small> (Price: {{stock.price}} | Cost: {{stock.price * quantity}}) </small>
                </h3>
            </div>
            <div class="panel-body">
                ...
                <div class="pull-right">
                    ...
                    <button class="btn btn-success" @click="buyStock" :disabled="insufficientFunds || quantity < 1 || !Number.isInteger(quantity)">
